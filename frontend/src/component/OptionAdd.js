...
return (
    <div className={styles.layout}>
        <div className={styles.title_Box}>
            <input placeholder="옵션" value={title} onChange={(e)=>{handleTitle(e)}}/>
        ...
        {optionList.map((item,index)=>(
            <div className={styles.option_Box} key={index}>
                <input className={styles.subOption} value={optionList[index].option} onChange={e => handleChangeOption(index, e)} placeholder="하위옵션"/>
                {optionList.length !== 1 && (
