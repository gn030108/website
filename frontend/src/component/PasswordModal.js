    ...
    <div className={styles.container}>
      <div className={styles.modal_box}>
        ...
        <div className={styles.input_box}>
          <label>현재 비밀번호</label>
          <input value={prePassword} onChange={(e)=>{dispatch(modalActions.getPrePassword(e.target.value))}}/>
        </div>
        <div className={styles.input_box}>
          <label>신규 비밀번호</label>
          <input value={newPassword} onChange={(e)=>{dispatch(modalActions.getNewPassword(e.target.value))}}/>
        </div>
        <div className={styles.input_box}>
          <label>비밀번호 확인</label>
          <input value={PasswordTest} onChange={(e)=>{dispatch(modalActions.getPasswordTest(e.target.value))}}/>
          {newPassword!=PasswordTest && newPassword!='' && PasswordTest!='' &&(
