    ...
    <div className={styles.container}>
      <div className={styles.modal_box}>
        ...
        <div className={styles.stars}>
          {starArray.map((index) => (
            <i
              ...
              style={score[index] ? { color: "#FF933B" } : { color: "#cdcdcd" }}
              onMouseOver={() => {
                starScore(index);
              }}
              key={index}
        ...
        <div className={styles.select_box}>
          <ReviewSelect List={size} type="사이즈" text={reviewSubmit.size} />
        </div>
        <div className={styles.select_box}>
          <ReviewSelect List={bright} type="밝기" text={reviewSubmit.bright} />
        </div>
        <div className={styles.select_box}>
          <ReviewSelect List={color} type="색" text={reviewSubmit.color} />
        </div>
        <div className={styles.select_box}>
          <ReviewSelect List={thick} type="두깨" text={reviewSubmit.thick} />
        </div>
        <div className={styles.select_box}>
          <ReviewSelect
            List={delivery}
