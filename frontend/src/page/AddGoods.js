          ...
          <div className={styles.itemTop_box} >
            ...
            <div>
              <div className={styles.top_image_box}>
                ...
                {preViewGoodsImg.length > 0 && (<img src={main} alt='상품 이미지'/>)}
              </div>
              ...
              <div className={styles.Info_box}>
                ...
                <div className={styles.info}>
                  ...
                  <div className={styles.colors}>
                    <li>
                      <a style={{backgroundColor:'black'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color="블랙"></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'white'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color="화이트"></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'navy'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color="네이비"></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'gray'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color="그레이"></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'#BACFE1'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color='연청'></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'#97AAC3'}} onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color='중청'></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'#232C41'}}onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color='진청'></a>
                    </li>
                    <li>
                      <a style={{backgroundColor:'#222B40'}}onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color='흑청'></a>
                    </li>
                    <li>
                      <a style={{backgroundImage:`url(${기타색상})`,backgroundSize:'contain'}}onClick={(e)=>{setColorTag(e.target.dataset.color)}} data-color='기타색상'></a>
                    </li>
