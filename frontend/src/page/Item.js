      ...
      <div className={styles.container}>
        <div style={{width:'fit-content'}}>
            ...
            <div className={styles.top_info_box}>
              ...
              {loginType !== 'admin' && (
                <div className={styles.Info_box} style={{display:'flex', justifyContent:'center', alignItems:'center', flexDirection:'column'}}>
                  ...
                  <div className={styles.selectBox} style={{marginTop:'15px'}}> 
                    <SelectBox
          ...
          <div className={styles.itemBot_box}>
              ...
              {
                isView ? (
                  <button className={styles.view_close} onClick={()=>(handleViewImage())}>상품 정보 접기</button>
                )
                :
                (
                  <button className={styles.view_open} onClick={()=>(handleViewImage())}>상품 정보 더보기</button>
                )
              }
